...
mysql> insert into student values(1,'pushpa','kumavat','pushpa@gmail.com','comps'),(2,'priyanka','kumavat','priyanka@gmail.com','bms'),(3,'tina','kumavat','tina@gmail.com','bcom'),(4,'janvi','yadav','janvi@gmail.com','it');
...
+------------+------------+-----------+--------------------+------------+
|          1 | pushpa     | kumavat   | pushpa@gmail.com   | comps      |
|          2 | priyanka   | kumavat   | priyanka@gmail.com | bms        |
|          3 | tina       | kumavat   | tina@gmail.com     | bcom       |
|          4 | janvi      | yadav     | janvi@gmail.com    | it         |
+------------+------------+-----------+--------------------+------------+
...
+------------+------------+-----------+---------------+-----------+
|          1 | pushpa     | kumavat   |           101 | c101      |
|          1 | pushpa     | kumavat   |           104 | r101      |
|          2 | priyanka   | kumavat   |           102 | c102      |
|          2 | priyanka   | kumavat   |           103 | e101      |
+------------+------------+-----------+---------------+-----------+
4 rows in set (0.00 sec)
